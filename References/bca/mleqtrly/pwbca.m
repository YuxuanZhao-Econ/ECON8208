...
[L,Sbar,P0,P,Q,A,B,C,param] = mleq(x0,0);
Y0       = 81;
gn       = param(1);
gz       = param(2);
beta     = param(3);
...
[i,j,C0] = fixexp(Sbar,P,Q,s0,[0;0;0;0]);
[i,j,C1] = fixexp(Sbar,P,Q,s0,[1;0;0;0]);
[i,j,C2] = fixexp(Sbar,P,Q,s0,[0;1;0;0]);
[i,j,C3] = fixexp(Sbar,P,Q,s0,[0;0;1;0]);
[i,j,C4] = fixexp(Sbar,P,Q,s0,[0;0;0;1]);
o        = ones(183,1);
