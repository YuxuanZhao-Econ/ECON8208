...
if computep;
  ...
  grid0=[ ...
   ...
   -0.3500 -0.2500 -0.2060 -0.1620 -0.0740 -0.0300  0.0500  0.25    0.55];
  [yd,Py,piy,psumy]=tauch3D(A,Sig,N,grid0);
  save tauchenadje2 A Sig N grid0 yd Py piy psumy
else
  load tauchenadje2
end;
...
if computep_ext==1;
  ...
  save tauchenextadje2 Pobs
else
  load tauchenextadje2
end
